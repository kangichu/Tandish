...
(function LoaderScreenScript(window = window, document = window.document, undefined = window.undefined || void 0) {
    ...
    let processingTime = 0,
        ...
        loaderScreenMessage = typeof window.loaderScreenMessage != 'undefined' ? window.loaderScreenMessage : 'LOADING',
    ...
    function update() {
        ...
        setTimeout(function() {
            ...
            // Modification > Data
                ...
                // Style
                data.style = 'align-items: center; background-color: rgba(255, 255, 255, .5); display: flex; flex-direction: column; height: ' + innerHeight + 'px; justify-content: center; left: 0; margin: auto; max-height: 100% !important; max-width: 100% !important; min-height: 100vh; min-width: 100vh; position: fixed; top: 0; transition: ' + loaderScreenTransition + 's ease-in-out; width: ' + innerWidth + 'px; z-index: 2147483647';
